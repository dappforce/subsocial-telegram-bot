...
exports.updateLastPush = exports.changeCurrentAccount = exports.updateTelegramChat = exports.getTelegramChat = exports.getAccountByChatId = exports.setTelegramData = exports.getNotifications = exports.getNewsFeed = void 0;
...
exports.getTelegramChat = async (account, chatId) => {
    try {
        const res = await axios_1.default.get(getOffchainUrl(`/getTelegramChat?account=${account}&chatId=${chatId}`));
        if (res.status === 200) {
            return res.data;
        }
    }
...
exports.updateTelegramChat = async (account, chatId, push_notifs, push_feeds) => {
    try {
        const res = await axios_1.default.post(getOffchainUrl(`/updateTelegramChat`), { account, chatId, push_notifs, push_feeds });
        if (res.status === 200) {
            return res.data;
        }
    }
...
exports.changeCurrentAccount = async (account, chatId) => {
    try {
        const res = await axios_1.default.post(getOffchainUrl(`/changeCurrentAccount`), { account, chatId });
        if (res.status === 200) {
            return res.data;
        }
    }
...
exports.updateLastPush = async (account, chatId, blockNumber, eventIndex) => {
    try {
        const res = await axios_1.default.post(getOffchainUrl(`/updateLastPush`), { account, chatId, blockNumber, eventIndex });
        if (res.status === 200) {
            return res.data;
        }
    }
